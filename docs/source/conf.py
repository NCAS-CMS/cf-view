# -*- coding: utf-8 -*-
#
# cf-view documentation build configuration file, created by
...
project = u'cf-view'
copyright = u'2024, Sadie Bartholomew NCAS-CMS'
...
latex_documents = [
  ('index', 'cf-view.tex', u'cf-view Documentation',
   u'swsheaps Heaps', 'manual'),
]
